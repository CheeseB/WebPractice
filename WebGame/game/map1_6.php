...
<body>
  ...
  <div class="btn">
    <span id = "left">
      <button type ="button" onclick ="location.href = 'map1_6.php'"> 왼쪽 </button>
    </span>
    <span id = "right">
      <button type ="button" onclick ="location.href = 'map1_clear.php'"> 오른쪽 </button>
    </span>
  </div>

  <div class="btn" style="text-align:center;">
    <br>
    <button type ="button" onclick ="location.href = 'map1_5.php'"> 아래 </button>
  </div>
