...
<body>
  ...
  <div class="btn" style="text-align:center;">
    <br>
    <button type ="button" onclick ="location.href = 'map3_5.php'"> 위 </button>
  </div>

  <div class="btn">
    <span id = "left">
      <button type ="button" onclick ="location.href = 'map3_3.php'"> 왼쪽 </button>
    </span>
    <span id = "right">
      <button type ="button" onclick ="location.href = 'map3_crack2.php'"> 오른쪽 </button>
    </span>
  </div>

  <div class="btn" style="text-align:center;">
    <br>
    <button type ="button" onclick ="location.href = 'map3_4.php'"> 아래 </button>
  </div>
